...
from tkinter import ttk, simpledialog, filedialog, Entry, Button
import pyautogui
import time
...
class MouseTrackerApp:
    ...
    def input_interval(cls):
        MouseTrackerApp.interval = simpledialog.askfloat("Input", "Interval in seconds", initialvalue=cls.interval)
    ...
    def choose_file_and_read(self):
        ...
        for line in file:
            time.sleep(MouseTrackerApp.interval)
    ...
    def __init__(self, root):
        ...
        file_menu.add_command(label='Interval', command=self.input_interval)
